...
import 'package:teknosoft/core/constants/constants.dart';
...
class ImportantTaskItemListView extends StatelessWidget {
  const ImportantTaskItemListView({
    super.key,
  });
    ...
    return BlocBuilder<TaskCubit, TaskState>(
      builder: (context, state) {
        ...
        List<TaskModel> filteredTasks = tasks.where((task) {
          return task.priority == (priority ?? priorityList[0]);
        }).toList();
